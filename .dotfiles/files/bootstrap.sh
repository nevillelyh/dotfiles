...
CASKS="adobe-creative-cloud alacritty alfred dropbox expressvpn google-chrome google-cloud-sdk guitar-pro iterm2 joplin keybase kindle macdive slack transmission visual-studio-code vimr vlc"
