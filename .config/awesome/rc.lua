...
globalkeys = gears.table.join(
    ...
    awful.key({ }, "XF86AudioPlay",        function() awful.spawn(awesome_path .. "scripts/sp play") end,
              {description = "Spotify - play",     group = "media"}),
    awful.key({ }, "XF86AudioPrev",        function() awful.spawn(awesome_path .. "scripts/sp prev") end,
              {description = "Spotify - previous", group = "media"}),
    awful.key({ }, "XF86AudioNext",        function() awful.spawn(awesome_path .. "scripts/sp next") end,
